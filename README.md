...
- [Data for all: Empowering teams with scalable Shiny applications](https://www.slideshare.net/RuanPearceAuthers/data-for-all-empowering-teams-with-scalable-shiny-applications-user-2019)   
